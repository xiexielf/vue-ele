			...
			.supports {
				.support-item {
					...
					.icon {
						...
						&.decrease {
							.background-img('img/decrease_4');
						}
						&.discount {
							.background-img('img/discount_4');
						}
						&.guarantee {
							.background-img('img/guarantee_4');
						}
						&.invoice {
							.background-img('img/invoice_4');
						}
						&.special {
							.background-img('img/special_4');
						}
					}
